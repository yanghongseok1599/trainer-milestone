      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <p>
              이 약관은 회사가 제공하는 트레이너 마일스톤 서비스(이하 &quot;서비스&quot;)의 이용조건 및
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제4조 (회원가입)</h2>
            <ul className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제5조 (서비스의 제공)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제8조 (이용자의 의무)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제9조 (콘텐츠의 저작권)</h2>
            <ul className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제10조 (서비스 이용 제한)</h2>
            <p>
              회사는 이용자가 본 약관의 의무를 위반하거나 서비스의 정상적인 운영을 방해한 경우,
              서비스 이용을 제한하거나 회원 자격을 정지 또는 상실시킬 수 있습니다.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제11조 (회사의 의무)</h2>
            <ul className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제12조 (면책조항)</h2>
            <ul className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제13조 (분쟁해결)</h2>
            <ul className="list-decimal pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-4">제14조 (기타)</h2>
            <p>
              본 약관에서 정하지 아니한 사항과 본 약관의 해석에 관하여는 관계 법령 및
              상관례에 따릅니다.
            </p>
          </section>
